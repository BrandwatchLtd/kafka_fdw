...
create foreign table kafka_openstack_alexey_1_valid(kafka_offset bigint, kafka_value text) server kafka_openstack_alexey_1 options (topic 'gnip.twitter', batch_size '30000', offset '-2');
