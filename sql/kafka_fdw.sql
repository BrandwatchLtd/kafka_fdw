...
create foreign table kafka_openstack_alexey_1_elephants(kafka_offset bigint, data text) server kafka_openstack_alexey_1 options (topic 'test', batch_size '30000', offset '0');
